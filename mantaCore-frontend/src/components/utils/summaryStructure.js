...
export const summaryStructure = [
    ...
    { key: 'totalPenjualan', title: 'Total Lifetime Sales', icon: '/assets/SummaryLogos/sales.png', isCurrency: true },
    { key: 'todayPnL', title: "Today's Profit & Loss", icon: '/assets/SummaryLogos/pnl.png', isCurrency: true },
    { key: 'lifetimePnL', title: 'Lifetime Profit & Loss', icon: '/assets/SummaryLogos/pnl.png', isCurrency: true },
    { key: 'totalInvoice', title: 'Total Invoices', icon: '/assets/SummaryLogos/invoice.svg', isCurrency: false },
